...
|------------------------------------------|---------------------------------------------------------------------------------|
| My interviewees seemed ot be more interested in how people should combat the spread of misinformation and disinformation.They thought it would be more impactful to use a call to action that emphasizes user actions rather than platform accountability.| My call to action for this project will be to encourage social media users to think critically about the information they consume and to check the sources of each article before sharing.|
